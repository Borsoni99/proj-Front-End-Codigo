...
export default function SobreNos() {
  ...
  return (
    <div className="App">
      ...
      <h1>Sobre nos</h1>
      <p className="Texto">Nossa equipe Lucky Roll especializada em projetos front-end, está empenhada na criação de um site de excelência para a empresa Nimbus. Nosso grupo está dedicado a desenvolver uma plataforma online que ofereça uma experiência de usuário intuitiva e de alta qualidade. Estamos aplicando nossos conhecimentos em design e desenvolvimento web para garantir que o site atenda às necessidades da empresa e de seus clientes, destacando-se pela funcionalidade, estética e acessibilidade. Nosso compromisso é entregar um produto final que eleve a presença online da Nimbus e impulsione sua interação com seu público-alvo de forma eficiente e impactante.</p>
